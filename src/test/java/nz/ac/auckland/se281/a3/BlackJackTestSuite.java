...
public class BlackJackTestSuite {
	...
	public static class YourTest extends TaskTest {
		@Test
		public void TESING() {
			BlackJack blackJack = new BlackJack(new Card(KING, CLUBS), new Card(FIVE, CLUBS), new Card(FIVE, CLUBS), // human
					new Card(KING, CLUBS), new Card(FIVE, HEARTS), new Card(THREE, HEARTS), new Card(FIVE, HEARTS), // BOT
																													// blackjack
																													// -
					// not // relevant
					new Card(ACE, HEARTS), new Card(JACK, SPADES), // BOT blackjack - not relevant
					new Card(KING, SPADES), new Card(FIVE, CLUBS), new Card(FIVE, HEARTS) // dealer should hit and be
			// busted
			);
			runCommands(blackJack, "LR", "100", "hit", "hold", " ", " ", " ", "no");
			assertContains("Round 1: Dealer's score is: 19");
